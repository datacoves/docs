            ...
            <Container py={{ base: '16', md: '24' }}>
              <Stack spacing={{ base: '8', md: '10' }}>
                <Stack spacing={{ base: '4', md: '5' }} align="center">
                  <Heading textAlign="center">Subscription process cancelled</Heading>
                  <Text textAlign="center">
                    You&apos;ve just cancelled the subscription process.
                  </Text>
                  <Text textAlign="center">
                    Contact us if you have any question, or start it over again.
                  </Text>
