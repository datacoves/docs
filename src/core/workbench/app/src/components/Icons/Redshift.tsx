...
export const RedshiftIcon = (props: any) => (
  <Icon viewBox="0 0 1615 1783.7" {...props}>
    ...
    <path d="m979.8 1783.7 258.4-129.2v-1525.3l-258.4-129.2-79 847z" fill="#5193ce" opacity=".9" />
    <path d="m635.2 1783.7-258.4-129.2v-1525.3l258.4-129.2 79 847z" fill="#205b97" />
    <path d="m635.2 0h348.1v1780.1h-348.1z" fill="#2e73b7" opacity=".8" />
  </Icon>
);
