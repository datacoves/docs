...
class _DatacovesBashDecoratedOperator(DecoratedOperator, DatacovesBashOperator):
    """
    ...
    template_fields: Sequence[str] = (
        ...
        *DatacovesBashOperator.template_fields,
    )
    template_fields_renderers: dict[str, str] = {
        **DecoratedOperator.template_fields_renderers,
        **DatacovesBashOperator.template_fields_renderers,
    }

    custom_operator_name: str = "@task.datacoves_bash"
...
def datacoves_bash_task(
    ...
    **kwargs,
    ...
    return task_decorator_factory(
        python_callable=python_callable,
        decorated_operator_class=_DatacovesBashDecoratedOperator,
        **kwargs,
    )
