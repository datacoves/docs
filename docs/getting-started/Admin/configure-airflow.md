...
1. Start with the initial configuration of Airflow in your Datacoves environment. Keep in mind that you will need to make changes to your repository to have the Datacoves and set default dbt profiles path for Airflow to use as well as the path where you will store your Airflow DAGs.
